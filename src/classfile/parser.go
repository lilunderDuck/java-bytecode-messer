...
func New(input io.Reader) *Parser {
	l := &Parser{Parser: bin.NewParser(input)}
	return l
}
...
func (p *Parser) readCaffbabe() error {
	...
	if !bytes.Equal(bs, []byte{0xCA, 0xFE, 0xBA, 0xBE}) {
		return errors.New("Wrong magic, expected 0xCAFEBABE")
	}
	return nil
}
...
func readAttributes(p bin.Parser, c *ConstantPool) ([]Attribute, error) {
	count, err := p.ReadUint16()
	if err != nil {
		return nil, err
	}
	...
	for ; i < count; i++ {
		...
		parser := bin.NewParser(bytes.NewBuffer(bs))
...
func readAttribute(p bin.Parser, attributeLength uint32, attributeName string, constantPool *ConstantPool) (Attribute, error) {
	var err error
...
func readRecordComponentInfo(parser bin.Parser, c *ConstantPool) (RecordComponentInfo, error) {
...
func readStackMapFrame(parser bin.Parser) (StackMapFrame, error) {
...
func readVerificationType(parser bin.Parser) (VerificationTypeInfo, error) {
...
func readAnnotation(parser bin.Parser) (*Annotation, error) {
	a := &Annotation{}
	var err error
...
func readElementValuePairs(parser bin.Parser) ([]*ElementValuePair, error) {
...
func readElementValuePair(parser bin.Parser) (*ElementValuePair, error) {
	p := &ElementValuePair{}
	var err error
...
func readParameterAnnotation(parser bin.Parser) (*ParameterAnnotation, error) {
...
func readTypeAnnotation(parser bin.Parser) (*TypeAnnotation, error) {
	a := &TypeAnnotation{}
...
func readTypeParameterTarget(parser bin.Parser) (TargetInfo, error) {
...
func readSuperTypeTarget(parser bin.Parser) (TargetInfo, error) {
...
func readTypeParameterBoundTarget(parser bin.Parser) (TargetInfo, error) {
...
func readFormalParameterTarget(parser bin.Parser) (TargetInfo, error) {
...
func readThrowsTarget(parser bin.Parser) (TargetInfo, error) {
	target := &ThrowsTarget{}
	var err error
...
func readLocalVarTarget(parser bin.Parser) (TargetInfo, error) {
...
func readLocalVarTargetTable(parser bin.Parser) (*LocalVarTargetTable, error) {
...
func readCatchTarget(parser bin.Parser) (TargetInfo, error) {
	target := &CatchTarget{}
	var err error
...
func readOffsetTarget(parser bin.Parser) (TargetInfo, error) {
	target := &OffsetTarget{}
	var err error
...
func readTypeArgumentTarget(parser bin.Parser) (TargetInfo, error) {
...
func readTypePath(parser bin.Parser) (*TypePath, error) {
...
func readElementValue(parser bin.Parser) (ElementValue, error) {
	tag, err := parser.ReadUint8()
	if err != nil {
		return nil, err
	}
...
func readElementValueConst(parser bin.Parser) (ElementValue, error) {
...
func readElementValueEnumConst(parser bin.Parser) (*ElementValueEnumConstValue, error) {
...
func readElementClassInfo(parser bin.Parser) (*ElementValueClassInfo, error) {
...
func readElementArrayValue(parser bin.Parser) (*ElementValueArrayValue, error) {
